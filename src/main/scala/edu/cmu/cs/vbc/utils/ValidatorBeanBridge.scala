...
object ValidatorBeanBridge {
  ...
  def unliftedEmptyInit(cName: String, cv: ClassVisitor): Unit = {
    ...
    mv.visitMethodInsn(INVOKESTATIC, Owner("edu/cmu/cs/vbc/VERuntime"), MethodName("globalEntryCtx"), MethodDesc(s"()$fexprclasstype"), false)
  ...
  def unliftedSetters(property: String, cName: String, cv: ClassVisitor): Unit = {
    ...
    callVCreateOne(mv, m => m.visitMethodInsn(INVOKESTATIC, Owner("edu/cmu/cs/vbc/VERuntime"), MethodName("globalEntryCtx"), MethodDesc(s"()$fexprclasstype"), false))
    mv.visitMethodInsn(INVOKESTATIC, Owner("edu/cmu/cs/vbc/VERuntime"), MethodName("globalEntryCtx"), MethodDesc(s"()$fexprclasstype"), false)
