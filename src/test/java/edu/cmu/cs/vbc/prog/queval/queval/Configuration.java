...
//	final static boolean False = false;
	...
	// index types
	@VConditional
	public static boolean Dwarf = true;
	@VConditional
	...
	@VConditional public static boolean InsertHeuristics = false;
	@VConditional public static boolean splitAlgos = false;
	@VConditional public static boolean SplitSize = false;
